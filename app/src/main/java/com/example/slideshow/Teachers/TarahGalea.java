...
public class TarahGalea extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.viewteacher);

        String Tname = "Ms Tarah Galea";
        String Tsubject = "Marketing - Naxxar";
        String Tdescr = "Lecturer at the university of Malta. Offering help for O,I or A-level";
        String TPrice = " € 15/hr";
        ...
        buttonCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:+35699230023"));
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[] { "tarahgalea@gmail.com" });
