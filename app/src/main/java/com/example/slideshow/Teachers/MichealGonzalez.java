...
public class MichealGonzalez extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.viewteacher);

        String Tname = "Dr Micheal Gonzalez";
        String Tsubject = "Maths - Mellieha";
        String Tdescr = "Lecturer at the university of Malta in a Phd in Maths and Stats. Offering group Sessions";
        String TPrice = " € 25/hr";
        ...
        buttonCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:+35699230123"));
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[] { "michealgonzalez@gmail.com" });
